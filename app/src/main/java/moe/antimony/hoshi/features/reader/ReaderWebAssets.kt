...
internal data class ReaderWebAssets(
    ...
    val readerContentStreamJs: String,
    val readerRangeMapJs: String,
    ...
    companion object {
        ...
        private fun read(context: Context): ReaderWebAssets =
            ReaderWebAssets(
                ...
                readerContentStreamJs = context.readAsset("hoshi-web/reader/reader-content-stream.js"),
                readerRangeMapJs = context.readAsset("hoshi-web/reader/reader-range-map.js"),
