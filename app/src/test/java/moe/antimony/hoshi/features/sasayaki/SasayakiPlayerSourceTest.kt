...
class SasayakiPlayerSourceTest {
    ...
    fun importedAudioUsesPersistedUriInsteadOfPrivateCopyLikeIos() {
        ...
        assertTrue(restoreAudio.contains("playback = playback"))
        ...
        assertFalse(restoreAudio.contains("audioRestore.restore("))
        assertFalse(restoreAudio.contains("callbacks = audioRestoreCallbacks.build("))
        assertFalse(restoreAudio.contains("onFailure(audioRestoreResult::handleFailure)"))
