...
- Pause Sasayaki auto-scroll on skipped image pages for one second, including multiple image pages, image-only chapters, vertical continuous reading, fullscreen image interruptions, and cue or progress seeks, without leaving playback paused when the hold is interrupted.
