...
- Keep Sasayaki playback owned by a foreground media playback service with wake-mode support so background playback can continue reliably, reader exit stops playback, and notification or launcher return opens the active reader.
