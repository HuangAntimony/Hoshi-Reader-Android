...
- Make reader sheets denser and smooth Appearance sheet scrolling by reducing row heights across Chapters, Appearance, Statistics, and Sasayaki, and prevent Appearance segmented controls from truncating labels or losing selected-state contrast in E-ink mode.
