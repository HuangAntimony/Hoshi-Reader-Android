...
- Extend the "Mine with options" sheet to also set the card's Picture: none, the book cover, or an image from a Bing search of the word. The choice fills the Picture field through a single `{image}` Anki marker.
