...
- Match Sasayaki subtitles immediately after selecting an SRT, including across
  combined-volume EPUBs and large text gaps, without requiring Search Window
  tuning or a separate Match action.
