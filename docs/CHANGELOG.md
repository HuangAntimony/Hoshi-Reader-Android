...
- Keep Dictionary search results tight below the search field, add the iOS-style pull-to-clear/show-keyboard gesture, and refocus with all search text selected when tapping the active Dictionary tab.
