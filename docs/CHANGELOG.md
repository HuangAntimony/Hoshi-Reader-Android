...
- Speed up paginated Reader chapter opens and cross-chapter turns by applying measured WebView viewport layout before reader JavaScript restores the chapter.
