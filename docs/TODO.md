...
- Next architecture slice: extract a small Sasayaki cue presentation state coordinator from `SasayakiPlayer` without changing auto-scroll or first-play reveal behavior.
