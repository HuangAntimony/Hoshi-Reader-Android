...
- Next architecture slice: extract a small Sasayaki media-session publishing coordinator from `SasayakiPlayer` without changing current time, duration, rate, active state, or transport metadata behavior.
