...
- Settings -> About shows the current version, can manually check GitHub Releases regardless of the automatic update setting, and opens downloaded APKs through Android's package installer.
