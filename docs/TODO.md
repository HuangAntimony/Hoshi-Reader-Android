...
- Device-validate remaining reader highlight restore, jump, delete, all-color, and continuous-mode behavior against iOS after paginated creation and native selection drag page-locking were verified on connected Android targets.
