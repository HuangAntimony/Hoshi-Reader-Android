...
- Next architecture slice: extract a small Sasayaki playback lifecycle controller from `SasayakiPlayer` without changing start, pause, seek, or release behavior.
