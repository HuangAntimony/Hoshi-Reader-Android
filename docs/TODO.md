...
- Next architecture slice: extract a small Sasayaki playback settings coordinator from `SasayakiPlayer` without changing delay/rate persistence or refresh behavior.
