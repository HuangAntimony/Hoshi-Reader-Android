...
- Next architecture slice: extract a small Sasayaki playback start coordinator from `SasayakiPlayer` without changing start, media-session activation, cue redisplay, or played-once behavior.
