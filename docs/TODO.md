...
- Device-validate remaining reader highlight restore, jump, delete, all-color, continuous-mode, and real-device selection-toolbar behavior against iOS after paginated creation, primary Highlight toolbar placement, and native selection drag page-locking were verified on Android targets.
