...
- Next architecture slice: introduce a DataStore-backed `DictionarySettingsRepository` and route dictionary settings UI/search call sites through observable state.
