...
- Device-validate native popup audio/Anki controls in Dictionary tab and reader lookup, covering duplicate state, audio error/autoplay, redirect history, collapsed dictionary toggles, child popups, and slow horizontal drags/long presses on controls.
